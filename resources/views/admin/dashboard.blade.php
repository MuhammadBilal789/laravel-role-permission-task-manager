...
<div class="container px-6 mx-auto grid">
    <div class="px-6 my-6" align="right"> </div>
  ...
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd" />
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                      ...
                      <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                          <div class="flex items-center space-x-2 text-sm">
                            <button onclick="location.href='{{ route('admin.tasks.show',$tasks->id)}}'"
                              class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                              aria-label="Edit"
                            >
                            <svg class="w-5 h-5" value
                                aria-hidden="true" viewBox="0 0 20 20" fill="currentColor">
                                <title>View</title>
                            ...
                            <button onclick="location.href='{{ route('admin.tasks.edit',$tasks->id)}}'"
                              class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                              aria-label="Edit"
                            >
                              <svg
                ...
                @if(count($total)>5))
                <button onclick="location.href='{{ route('admin.tasks.index') }}'" class="flex items-center justify-between w-half px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                  Show all
                </button>
                @endif
