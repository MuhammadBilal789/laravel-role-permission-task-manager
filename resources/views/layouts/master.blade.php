          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Task Manager</span>
              </a>
            </li>
          ...
          <ul>
            <li class="relative px-6 py-3">
              ...
              stroke="currentColor">
                ...
                <span class="ml-4">Permission Manager</span>
              </a>
            </li>
          </ul>
          @endrole
          <div class="px-6 my-6">
            <button onclick="location.href='{{ url('https://github.com/MuhammadBilal789/laravel-role-permission-task-manager target="_blank"' ) }}'"
            ...
            <svg
              ...
              <p align="left">Star This Project</p>
            </button>
          </div>
        </div>
      </aside>
